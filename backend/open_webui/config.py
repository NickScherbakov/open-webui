...
# YANDEX GPT API
####################################
ENABLE_YANDEXGPT_API = PersistentConfig(
    "ENABLE_YANDEXGPT_API",
    "yandexgpt.enable",
    os.environ.get("ENABLE_YANDEXGPT_API", "False").lower() == "true",
)
YANDEXGPT_API_KEY = PersistentConfig(
    "YANDEXGPT_API_KEY",
    "yandexgpt.api_key",
    os.environ.get("YANDEXGPT_API_KEY", ""),
)
YANDEXGPT_FOLDER_ID = PersistentConfig(
    "YANDEXGPT_FOLDER_ID",
    "yandexgpt.folder_id",
    os.environ.get("YANDEXGPT_FOLDER_ID", ""),
)
YANDEXGPT_API_BASE_URL = PersistentConfig(
    "YANDEXGPT_API_BASE_URL",
    "yandexgpt.api_base_url",
    os.environ.get("YANDEXGPT_API_BASE_URL", "https://llm.api.cloud.yandex.net"),
)
YANDEXGPT_MODELS = PersistentConfig(
    "YANDEXGPT_MODELS",
    "yandexgpt.models",
    [
        "yandexgpt",
